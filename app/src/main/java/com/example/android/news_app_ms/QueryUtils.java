...
public final class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // key called "results", which represents a list of all results of all news
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Create a new {@link newsList} object with the title, name, url, date/time and author from the JSON response.
                News newsList = new News(title, sectionName, url, publicationDate, Author);
